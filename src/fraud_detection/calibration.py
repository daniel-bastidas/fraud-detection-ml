...
def calibrate_pipeline(pipe: Pipeline, X_valid: pd.DataFrame, y_valid: pd.Series, method: str = "isotonic") -> CalibratedClassifierCV:
    """
    ...
    calib = CalibratedClassifierCV(base_estimator=pipe, cv="prefit", method=method)
